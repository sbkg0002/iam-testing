...
def setup_command(args):
    ...
    if args.bucket:
        ...
        print(f"Bucket setup complete: {args.bucket_name}")
...
def teardown_command(args):
    ...
    if args.role:
        ...
        if success:
            ...
            print(f"Role {args.role_name} did not exist")
...
def main():
    ...
    setup_parser.add_argument("--role-name", default=DEFAULT_ROLE_NAME, help="Name for the test IAM role")
    ...
    setup_parser.add_argument("--bucket-name", default=DEFAULT_TEST_BUCKET, help="Name for the test S3 bucket")
    ...
    teardown_parser.add_argument("--role-name", default=DEFAULT_ROLE_NAME, help="Name of the test IAM role to delete")
